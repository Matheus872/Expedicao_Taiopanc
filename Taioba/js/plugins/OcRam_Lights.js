...
"use strict"; if (!Imported || !Imported.OcRam_Core) alert('OcRam_Core.js ' +
    'is required!'); OcRam.addPlugin("Lights", "2.09");

/*:
 * @plugindesc v2.09 You may use event comments or plugin commands to control different type of light sources. PLUGIN NAME MUST BE OcRam_Lights.js
 * @author OcRam
 *
...
(function () {
    ...
    Light_Data.prototype.update = function (light_layer, ctx) {
        ...
        switch (this._lightType) {
            ...
            case _lightType.Flicker_Little: // Flickering a lot (like realy broken light) 10% on / 90 % off
                if (this._flicksRemaining == 0) {
                    if (!this._flickIsOn) {
