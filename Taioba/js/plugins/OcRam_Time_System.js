...
"use strict"; if (!Imported || !Imported.OcRam_Core) alert('OcRam_Core.js ' +
    'is required!'); OcRam.addPlugin("Time_System", "2.09");

/*:
 * @plugindesc v2.09 Time System for RPG Maker MV projects.
...
(function () {
    ...
    window.processInterval_OC = function () {
        ...
        if ($gameSwitches.value(_timeEnabledSwitchId) && !_isInteracting) {
            OcRam_Utils.addMinutes(1); if (_changeTilesetImmediatly) _this.updateSeasonalTileset();
        }
    };
